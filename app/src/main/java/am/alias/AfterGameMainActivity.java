...
public class AfterGameMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_game_main);
    ...
    public void editTextList() {
        try {
            if (editTextTeamName1 == null) {
                Resources.teamName1 = "Group Name 1";
            }
            if (editTextTeamName2 == null) {
